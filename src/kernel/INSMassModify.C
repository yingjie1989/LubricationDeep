...
INSMassModify::INSMassModify(const InputParameters & parameters) :
    Kernel(parameters),
...
Real INSMassModify::computeQpResidual()
{
  // (div u) * q
...
Real INSMassModify::computeQpJacobian()
{
...
Real INSMassModify::computeQpOffDiagJacobian(unsigned jvar)
{
